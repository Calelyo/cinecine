...
const imagenesPeliculas = require.context('../img/portadas', true)
...
export const Peliculas = [
        ...
        },
        {
            ...
            PEGI: 'ATP',
            sinopsis: 'Esta película sigue el viaje de un joven apasionado por la música que, después de encontrar un antiguo bandoneón en el desván de su abuelo, decide aprender a tocar este instrumento icónico del tango argentino. A medida que se sumerge en el mundo de la música y el baile del tango, descubre secretos familiares enterrados y encuentra el amor en los sonidos apasionados de su bandoneón.',
            estreno: false,
            poster: '',
            imagen: '',
            hay_funcion: false
