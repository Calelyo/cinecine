...
import PantallaCarga from '@/app/utilidad/PantallaCarga'

const funciones = Funciones;
const peliculas = Peliculas;

export default function CompraHandle({ info }){
    // const { id_pelicula } = params
    // const id_pelicula = params.id_pelicula.split('_')[0]
    const [id_pelicula, nombre, con3d, conSubtitulos] = info.split('_')
    // console.log(info)
